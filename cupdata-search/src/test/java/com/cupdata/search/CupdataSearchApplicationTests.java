...
@SpringBootTest
class CupdataSearchApplicationTests {
...
//						ResponseVo<List<SkuAttrValueEntity>> skuAttrValueResponseVo = pmsInfoClient.queryAttrValueBySkuId(skuEntity.getId());
						ResponseVo<List<SkuAttrValueEntity>> skuAttrValueResponseVo = pmsInfoClient.querySearchSkuAttrValuesByCidAndSkuId(skuEntity.getCatagoryId(), skuEntity.getId());
...
//						ResponseVo<List<SpuAttrValueEntity>> spuAttrValueResponseVo = pmsInfoClient.querySpuAttrValueBySpuId(spuEntity.getId());
						ResponseVo<List<SpuAttrValueEntity>> spuAttrValueResponseVo = pmsInfoClient.querySearchSpuAttrValuesByCidAndSpuId(skuEntity.getCatagoryId(), skuEntity.getId());
